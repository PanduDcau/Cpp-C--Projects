...
{                        
    ...
    do
    {
        num = *(int *)(carrier+1);//Next block segment address of the memory

        if(*carrier == fflag && num >= Capacity + 5)
        {
            return (carrier);
        }else if(!carrier)
        {
            ...
            if( carrier + num + Capacity >= MalArray + 24999)
            {
